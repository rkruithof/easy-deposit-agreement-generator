#!/usr/bin/env bash
#  /etc/init.d/easy-deposit-agreement-generator

# ***** FILL IN APPROPRIATE RUN-LEVELS, START-UP AND SHUTDOWN PRIORITIES !!! ******
# chkconfig: 2345 92 58

# Provides:          easy-deposit-agreement-generator
# Short-Description: Starts the easy-deposit-agreement-generator service
# Description:       This file is used to start the daemon
#                    and should be placed in /etc/init.d

NAME="easy-deposit-agreement-generator"
EXEC="/usr/bin/jsvc"
